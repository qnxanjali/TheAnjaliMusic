...
async def about_callback(client: Client, callback_query: CallbackQuery):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/+b1gc4qrvfLZlNGI1"
            ),
        ],
        [
            InlineKeyboardButton(text="ɴᴇᴛᴡᴏʀᴋ", url=f"t.me/ANJALINETWORK"),
            InlineKeyboardButton(text="ᴀʟʟ ʙᴏᴛs", url=f"https://t.me/qnxanjaliabout/4"),
        ],
        [
...
async def music_callback(client: Client, callback_query: CallbackQuery):
    ...
    await callback_query.message.edit(
        f"**Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ.](t.me/+b1gc4qrvfLZlNGI1)**\n\n**Aʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ: /**",
        reply_markup=keyboard,
    )
...
async def back_button_callback(client: Client, callback_query: CallbackQuery):
    keyboard = [
        [
            ...
            InlineKeyboardButton(
                text="ᴀʟʟ ʙᴏᴛs",
                url="https://t.me/qnxanjaliabout/4",
            ),
        ],
        [
